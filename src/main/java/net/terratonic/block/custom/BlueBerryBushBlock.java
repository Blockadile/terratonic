...
public class BlueBerryBushBlock extends PlantBlock implements Fertilizable {
    ...
    private static final VoxelShape SMALL_SHAPE = Block.createCuboidShape(3.0F, 0.0F, 3.0F, 13.0F, 8.0F, 13.0F);
    private static final VoxelShape LARGE_SHAPE = Block.createCuboidShape(1.0F, 0.0F, 1.0F, 15.0F, 16.0F, 15.0F);
